...
const Contact = ({ id }: ContactProps) => {
  const contactInfo = {
    email: 'ritz.alonzo@gmail.com',
    phone: '+63 917-506-3313',
    location: 'Quezon City, Philippines',
    github: 'https://github.com/ritz-alonzo',
    linkedin: 'https://www.linkedin.com/in/ritz-alonzo'
  }
      ...
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-description">
            Have a project in mind? Let's discuss how I can help bring your ERP vision to life.
          </p>
        </div>
        ...
        <div className="contact-content">
          <div className="contact-info">
            ...
            <p className="contact-intro">
              I'm always interested in new opportunities, especially ambitious or large-scale ERP projects. 
            ...
            <div className="contact-methods">
              ...
              <a href={`tel:${contactInfo.phone.replace(/[^0-9+]/g, '')}`} className="contact-item">
                <div className="contact-icon">📱</div>
                <div className="contact-details">
          ...
          <div className="contact-cta">
            <div className="cta-card">
              ...
              <p>
                ...
                with custom .NET Core Application or Acumatica solutions.
              </p>
              <a href={`mailto:${contactInfo.email}`} className="btn btn-primary">Send Me an Email</a>
